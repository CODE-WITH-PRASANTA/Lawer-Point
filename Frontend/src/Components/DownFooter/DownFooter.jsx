    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-top">
          <p className="company-name">© 2025 PR-WEBSTOCK. All Rights Reserved.</p>
        ...
        <div className="footer-bottom">
          <p className="footer-contact">
            Need help? Email us at <a href="mailto:prwebstock.com@gmail.com" className="footer-link">lawyerpoint.com@gmail.com</a>
          </p>
        </div>
      </div>
    </footer>
